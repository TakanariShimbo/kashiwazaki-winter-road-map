 ...
 * 配色はブルー同系統で統一。太さは太(4)/細(2)の2種のみ。除雪・緊急確保は同色で太さ違い、歩道は点線。 */
export const LAYERS: LayerConfig[] = [
  { key: 'hodo',    name: '歩道除雪',     color: '#7fb0de', width: 2, dash: 'dotted', files: ['hodo'], defaultOn: false, fields: ['路線名', '水準', '除雪路線延長'] },
  ...
  { key: 'kinkyu',  name: '緊急確保路線', color: '#163e8c', width: 4, dash: 'solid',  files: ['kinkyu'], defaultOn: true, fields: ['路線名', '区分', '路線種別', '除雪路線延長', 'その他必要情報'] },
  { key: 'pipe',    name: '消雪パイプ',   color: '#0a84ff', width: 4, dash: 'solid',  files: ['shosetsu_pipe'], defaultOn: true, fields: ['路線名', '管理番号', '施設番号', '設置場所'] },
]
